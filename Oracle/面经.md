...
## data
DB的某个组店面：Java的各种基础知识，Process和Thread的区别，Java和C++的区别，几道基础的算法题，包括一个数组中找只出现一次的数字，etc.
Onsite:(75min)
1. Reverse LinkedList
2. 在一个sorted array中找到没有sorted的区间。
3. longest substring containing no more than k characters.
面试的全都是印度小哥，聊了聊说想找CS基础比较扎实，并且熟练掌握至少一门编程语言的学生。
算法题都不难，所以过程一直在聊天，问问题，聊天，问问题，问问题.... = =. From 1point 3acres bb
...
1.easy题目，找log里面usage数值最大的ID，follow-up问同一个ID可能有很多个usage，加一下就好了，继续问log很大，在不同机器上怎么办，应该是想让我说mapreduce，我不大懂这方面
2.OOD，parking lot
3.manager一起吃饭聊天BQ
4.battleship
5.merge intervals
有一轮是bar raise 不知道是哪一轮，每一轮都要求问一些BQ，感觉面的不算特别好，竟然收到offer了
...
1. permutation，
2. all subset
3. implement a stack 要求是 pop，push，getMinValue 都要是 O(1) 的时间复杂度，
4. 用loop, move left, move right, the tileIsVisitedByOther 这四种指令program机器人，使得如果两个机器人在数轴上走总会相撞。
完全没有任何的behavior questions。

## 非oci组
题目比较非主流，一道算法题都没有。问了很多语言和CS的基础知识，有两轮设计，而且问得极其详细。

第一面：设计电商网站的Inventory system。基本要求就是add cart的时候更新inventory system，同步异步更新，并发如何解决，还要写出API。
